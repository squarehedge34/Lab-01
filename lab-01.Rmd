...
NA stands for non applicable and is being gotten because some of the data isn't in the same type or contains non applicable data.
...
na.rm is a command that makes it so the NA values are skipped.
...
not normally distributed as there are some outliers 
